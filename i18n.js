...
const STRINGS = {
  ...
  "index.news_title":     { en: "Latest News",
                            es: "Últimas Noticias" },
  "index.news1_date":     { en: "July 2026",
                            es: "Julio 2026" },
  ...
  "index.socials_sub":    { en: "Stay up to date and get to know us better on our social media.",
                            es: "Estate al tanto y conócenos mejor en nuestras redes sociales." },
  ...
  "erika.trailer_btn":    { en: " Watch trailer",
                            es: " Ver tráiler" },
  "erika.trailer_h":      { en: "Official trailer",
                            es: "Tráiler oficial" },
  "erika.about_h":        { en: "About the game",
                            es: "Sobre el Juego" },
  ...
  "erika.info_dev_l":     { en: "Developer",
                            es: "Desarrollador" },
  "erika.info_status_l":  { en: "Status",
                            es: "Estado" },
  "erika.info_status_v":  { en: "In Development - 2026",
                            es: "En Desarrollo - 2026" },
  "erika.info_plat_l":    { en: "Platforms",
                            es: "Plataformas" },
  "erika.screenshots_h":  { en: "Screenshots",
  ...
  "dev.kav_bio":         { en: "Heyyy! I'm one of the team's artists, a programmer, and the official coffee taster.<br><br>Art has been with me ever since I started seeing it everywhere, inspiring me to learn programming so I could create indie games through it.",
                           es: "¡Heyyy! Soy una de las artistas, programadora y catadora oficial de café del equipo.<br><br>El arte me acompaña desde que empecé a verlo en todas partes, inspirándome a aprender programación para crear juegos indies con él." },
